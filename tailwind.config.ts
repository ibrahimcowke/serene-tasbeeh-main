  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        counter: {
          bg: "hsl(var(--counter-bg) / <alpha-value>)",
          ring: "hsl(var(--counter-ring) / <alpha-value>)",
          text: "hsl(var(--counter-text) / <alpha-value>)",
          glow: "hsl(var(--counter-glow) / <alpha-value>)",
        },
        arabic: "hsl(var(--arabic-text) / <alpha-value>)",
        progress: {
          track: "hsl(var(--progress-track) / <alpha-value>)",
          fill: "hsl(var(--progress-fill) / <alpha-value>)",
        },
        sheet: {
      ...
      animation: {
        ...
        "count-pop": "count-pop 0.15s ease-out",
