...
export const counterShapes = [
  ...
  { id: 'geometric-star', label: 'Star', icon: '۞', color: '#fbbf24', bg: 'rgba(251, 191, 36, 0.1)' },
  { id: 'fluid', label: 'Fluid', icon: '≈', color: '#a78bfa', bg: 'rgba(167, 139, 250, 0.1)' },
  { id: 'radar', label: 'Radar', icon: '⊕', color: '#22c55e', bg: 'rgba(34, 197, 94, 0.1)' },
  { id: 'real-beads', label: 'Real', icon: '📿', color: '#71717a', bg: 'rgba(113, 113, 122, 0.1)' },
  { id: 'glass-orb', label: 'Glass', icon: '🔮', color: '#2dd4bf', bg: 'rgba(45, 212, 191, 0.1)' },
  { id: 'portal-depth', label: 'Portal', icon: '◎', color: '#6366f1', bg: 'rgba(99, 102, 241, 0.1)' },
  ...
  { id: 'steampunk-nixie', label: 'Steam', icon: '⚙', color: '#f59e0b', bg: 'rgba(245, 158, 11, 0.1)' },
  { id: 'biolum-organic', label: 'Bio', icon: '🧬', color: '#10b981', bg: 'rgba(16, 185, 129, 0.1)' },
  { id: 'solar-flare', label: 'Solar', icon: '☀', color: '#f97316', bg: 'rgba(249, 115, 22, 0.1)' },
  { id: 'nebula-cloud', label: 'Nebula', icon: '🌥', color: '#8b5cf6', bg: 'rgba(139, 92, 246, 0.1)' },
  { id: 'infinite-knot', label: 'Knot', icon: '➰', color: '#ec4899', bg: 'rgba(236, 72, 153, 0.1)' },
  { id: 'holo-fan', label: 'Fan', icon: '☄', color: '#06b6d4', bg: 'rgba(6, 182, 212, 0.1)' },
  ...
  { id: 'blooming-lotus', label: 'Lotus', icon: '🌸', color: '#f472b6', bg: 'rgba(244, 114, 182, 0.1)' },
  { id: 'constellation', label: 'Stars', icon: '🌌', color: '#6366f1', bg: 'rgba(99, 102, 241, 0.1)' },
  ...
  { id: 'star-burst', label: 'Starburst', icon: '💥', color: '#f97316', bg: 'rgba(249, 115, 22, 0.1)' },
  { id: 'crystal-prism', label: 'Prism', icon: '💎', color: '#a855f7', bg: 'rgba(168, 85, 247, 0.1)' },
  { id: 'galaxy', label: 'Galaxy', icon: '🌌', color: '#6366f1', bg: 'rgba(99, 102, 241, 0.1)' },
  ...
  { id: 'lava-lamp', label: 'Lava Lamp', icon: '💧', color: '#f43f5e', bg: 'rgba(244, 63, 94, 0.1)' },
  { id: 'matrix-code', label: 'Matrix', icon: '📟', color: '#22c55e', bg: 'rgba(34, 197, 94, 0.1)' },
  { id: 'sunset-horizon', label: 'Sunset', icon: '🌅', color: '#f97316', bg: 'rgba(249, 115, 22, 0.1)' },
  { id: 'mechanical-lock', label: 'Vault', icon: '🔒', color: '#a8a29e', bg: 'rgba(168, 162, 158, 0.1)' },
  { id: 'plasma-ball', label: 'Plasma', icon: '⚡', color: '#8b5cf6', bg: 'rgba(139, 92, 246, 0.1)' },
  { id: 'origami-crane', label: 'Origami', icon: '🦢', color: '#f472b6', bg: 'rgba(244, 114, 182, 0.1)' },
  { id: 'retro-lcd', label: 'LCD', icon: '📟', color: '#4ade80', bg: 'rgba(74, 222, 128, 0.1)' },
  { id: 'zen-garden', label: 'Zen', icon: '🎋', color: '#10b981', bg: 'rgba(16, 185, 129, 0.1)' },
  { id: 'fire-embers', label: 'Embers', icon: '🔥', color: '#ef4444', bg: 'rgba(239, 68, 68, 0.1)' },
] as const;
