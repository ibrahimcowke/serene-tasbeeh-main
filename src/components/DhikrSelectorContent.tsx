...
interface DhikrSelectorContentProps {
      ...
      <div className="flex flex-col gap-3 px-1 mb-4">
        <div className="relative w-full">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2 rounded-xl bg-secondary border-none focus:ring-1 focus:ring-primary/20 text-sm text-foreground"
            value={searchQuery}
        ...
        <div className="grid grid-cols-1 gap-2 mb-6">
          {allDhikrs.map((dhikr) => (
            <motion.div
              ...
              className={`
                relative p-4 rounded-2xl flex items-center justify-between group transition-all cursor-pointer
                ${currentDhikr.id === dhikr.id ? 'bg-primary/10 ring-1 ring-primary/20' : 'bg-card hover:bg-secondary/50'}
                ${sessionMode.type !== 'free' && !sessionMode.isComplete ? 'opacity-50 cursor-not-allowed' : ''}
              `}
            >
              ...
              <div className="space-y-3">
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    dir="rtl"
                    className="w-full px-4 py-2.5 rounded-xl bg-secondary border-none font-arabic text-xl text-foreground"
                  />
                ...
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 rounded-xl bg-secondary border-none text-sm text-foreground"
                  />
...
export default DhikrSelectorContent;
