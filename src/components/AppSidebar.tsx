                            ...
                            <SidebarMenuButton asChild tooltip={t('nav.settings')} size="lg">
                                ...
                                >
                                    ...
                                    <div className="flex flex-col text-left">
                                        <span className="text-sm font-light tracking-wide leading-none">{t('nav.settings')}</span>
                                        <span className="text-[10px] text-muted-foreground/60 font-light mt-1">{t(`theme.${theme}.label`)}</span>
                                    </div>
                                </button>
                            </SidebarMenuButton>
                        </SettingsView>
