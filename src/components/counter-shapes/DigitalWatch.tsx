...
export function DigitalWatch({ currentCount }: { currentCount: number }) {
    return (
        <div className="flex flex-col items-center justify-center -z-10 w-full h-full relative scale-[0.9]">
            <div className="w-[190px] h-[256px] bg-neutral-900 rounded-[50px] shadow-[inset_0_2px_10px_rgba(255,255,255,0.2),0_10px_30px_rgba(0,0,0,0.8)] border-[4px] border-neutral-700 flex flex-col items-center justify-center relative overflow-hidden">
                ...
                <div className="w-[170px] h-[210px] bg-black rounded-[40px] border border-neutral-800/50 shadow-[inset_0_0_20px_rgba(0,0,0,1)] relative flex flex-col items-center justify-center overflow-hidden">
