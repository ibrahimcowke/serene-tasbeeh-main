    ...
    return (
        <div className="relative w-64 h-64 flex items-center justify-center -z-10">
            <div className="relative w-[220px] h-[220px] flex items-center justify-center">
                ...
                >
                    <div className="absolute inset-0 bg-original-primary/30 backdrop-blur-md shadow-[0_0_30px_hsl(var(--original-primary)/0.5)] border border-original-primary/50"
                        style={{ clipPath: 'polygon(50% 0%, 100% 25%, 100% 75%, 50% 100%, 0% 75%, 0% 25%)', transform: 'translateZ(40px)' }} />

                    <div className="absolute inset-0 bg-original-primary/10 border border-original-primary/20"
                        style={{ clipPath: 'polygon(50% 0%, 100% 25%, 100% 75%, 50% 100%, 0% 75%, 0% 25%)', transform: 'translateZ(-40px)' }} />
                </motion.div>

                <motion.div
                    className="absolute w-[80px] h-[100px] bg-original-primary/80 blur-sm"
