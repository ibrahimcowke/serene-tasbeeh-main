...
export function VerticalCapsules({ currentCount }: VerticalCapsulesProps) {
    ...
    return (
        <div className="relative w-64 h-64 flex items-center justify-center -z-10 bg-slate-100/10 rounded-full border border-white/20 backdrop-blur-sm overflow-hidden">
