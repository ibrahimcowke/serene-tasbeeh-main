...
export function HadithSlider({ dhikr }: { dhikr: Dhikr }) {
    ...
    return (
        <div
            className="w-full max-w-[606px] min-h-[80px] xs:min-h-[100px] md:min-h-[140px] bg-card/40 hover:bg-card/60 backdrop-blur-md rounded-2xl border border-border/40 p-3 sm:p-4 md:p-5 flex flex-col justify-center relative overflow-hidden transition-all duration-300 group shadow-xl mx-auto"
