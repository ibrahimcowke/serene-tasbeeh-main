...
export const initialThemeSettings: Record<string, ThemeSettings> = {
  ...
  'theme-nord-deep': { ...defaultThemeSettings, primary: '#88c0d0', background: '#17202b', card: '#212c3b', text: '#eceff4', textMuted: '#d8dee9', border: '#263445', accent: '#81a1c1', secondary: '#2f4354' },
  'theme-nord-midnight': { ...defaultThemeSettings, primary: '#a3be8c', background: '#0d1221', card: '#131c33', text: '#eceff4', textMuted: '#d8dee9', border: '#1a2645', accent: '#b48ead', secondary: '#1b2640' },
  ...
  'theme-cyber-twilight': { ...defaultThemeSettings, primary: '#ff79c6', background: '#120a24', card: '#1b0f36', text: '#fde7ff', textMuted: '#a78bfa', border: '#221344', accent: '#00ffff', secondary: '#281b50' },
  'theme-dracula-evolved': { ...defaultThemeSettings, primary: '#e94560', background: '#2b0e15', card: '#3d141e', text: '#f8f8f2', textMuted: '#bd93f9', border: '#4c1925', accent: '#bd93f9', secondary: '#511b27' },
  'theme-espresso-dark': { ...defaultThemeSettings, primary: '#ddb892', background: '#24160f', card: '#342016', text: '#f4ebe1', textMuted: '#b08968', border: '#42291c', accent: '#7f5539', secondary: '#452b1d' },
  'theme-glass': { ...defaultThemeSettings, primary: '#0ea5e9', background: '#f0f9ff', card: '#ffffff', text: '#0f172a', textMuted: '#64748b' },
  'theme-sunset': { ...defaultThemeSettings, primary: '#f97316', background: '#2b0d09', card: '#3f130d', text: '#431407', textMuted: '#9a3412', border: '#4e1810', accent: '#d946ef', secondary: '#521c13' },
  'theme-forest': { ...defaultThemeSettings, primary: '#10b981', background: '#0d2b1a', card: '#133f26', text: '#e6fffa', textMuted: '#34d399', border: '#184e2f', accent: '#fbbf24', secondary: '#1b5133' },
  'theme-oled': { ...defaultThemeSettings, primary: '#ffffff', background: '#000000', card: '#000000', text: '#ffffff', textMuted: '#a3a3a3' },
  'theme-desert-starlight': { ...defaultThemeSettings, primary: '#38bdf8', background: '#291d14', card: '#3d2b1f', text: '#fef3c7', textMuted: '#d97706', border: '#4c3627', accent: '#f59e0b', secondary: '#4e3828' },
