...
export default function MiniCounter() {
    ...
    return (
        <ThemeProvider>
            <div className="h-dvh min-h-svh w-screen bg-background flex flex-col items-center justify-center p-4 relative overflow-hidden select-none">
                {/* Pattern Background */}
                ...
                <div className="relative z-10 text-center mb-6 mt-8">
                    ...
                    <h3 className="text-xs text-muted-foreground line-clamp-1 opacity-80">
